...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        local wallpaper = gears.wallpaper.maximized("/home/andres/Pictures/Wallpapers/beeple-broken_moon.jpg", s)
        -- local wallpaper = gears.wallpaper.set("#f0f0f0")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "web", "code", "files", "music", "games", "comms", "ex1", "ex2", "ex3" }, s, awful.layout.layouts[1])
